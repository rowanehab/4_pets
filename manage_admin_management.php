...
if(isset($_POST['submit'])){
	...
	$resEmail=mysqli_query($conn,"select * from admin_users where email='$email'");
	...
	$resphone=mysqli_query($conn,"select * from admin_users where mobile='$mobile'");
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="mobile" class="form-control" id="phone"
                                    placeholder="+20(___) ___-____" required value="<?php echo $mobile?>" />
                            </div>
